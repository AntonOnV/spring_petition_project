...
public class PetitionController implements PetitionsApi {
    ...
    @Override
    public ResponseEntity<PetitionResponse> addVote(Integer id) {
    ...
    @Override
    public ResponseEntity<Void> deletePetitionById(Integer id) {
        petitionService.deletePetition(id);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }

    @Override
    public ResponseEntity<List<PetitionResponse>> listPetitions(Integer limit, Integer pageNumber, String filter) {
    ...
    @Override
    public ResponseEntity<PetitionResponse> getPetitionById(Integer id) {
    ...
    @Override
    public ResponseEntity<PetitionResponse> updatePetitionById(Integer id, PetitionRequest petitionRequest) {
