...
public class PetitionController implements PetitionsApi {
    ...
    @Override
    public ResponseEntity<PetitionResponse> addVote(String id) {
    ...
    @Override
    public ResponseEntity<Void> deletePetitionById(String id) {
    ...
    @Override
    public ResponseEntity<PetitionResponse> getPetitionById(String id) {
    ...
    @Override
    public ResponseEntity<PetitionResponse> updatePetitionById(String id, PetitionRequest petitionRequest) {
    ...
    private static PetitionResponse mapToResponse(Petition petition) {
        ...
        petitionResponse.setVotes(petition.getVotes().size());
