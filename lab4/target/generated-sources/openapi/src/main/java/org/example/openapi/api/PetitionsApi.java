...
public interface PetitionsApi {
    ...
    default ResponseEntity<PetitionResponse> addVote(@ApiParam(value = "The id of the petition to retrieve", required = true) @PathVariable("id") String id) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"name\" : \"name\", \"description\" : \"description\", \"votes\" : 0, \"id\" : \"id\" }";
    ...
    default ResponseEntity<Void> deletePetitionById(@ApiParam(value = "The id of the petition to retrieve", required = true) @PathVariable("id") String id) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<PetitionResponse> getPetitionById(@ApiParam(value = "The id of the petition to retrieve", required = true) @PathVariable("id") String id) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"name\" : \"name\", \"description\" : \"description\", \"votes\" : 0, \"id\" : \"id\" }";
    ...
    default ResponseEntity<PetitionResponse> updatePetitionById(@ApiParam(value = "The id of the petition to retrieve", required = true) @PathVariable("id") String id,@ApiParam(value = "Name and description for the petition", required = true) @Valid @RequestBody PetitionRequest petitionRequest) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"name\" : \"name\", \"description\" : \"description\", \"votes\" : 0, \"id\" : \"id\" }";
